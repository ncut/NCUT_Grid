<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Sensor2_Chart.ascx.cs" Inherits="demo.UserControl.Sensor2_Chart" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
    ...
    <SelectParameters>
        <asp:Parameter DefaultValue="11" Name="传感器编号" Type="Int32" />
    </SelectParameters>
</asp:SqlDataSource>
