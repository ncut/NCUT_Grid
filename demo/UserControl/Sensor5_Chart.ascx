<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Sensor5_Chart.ascx.cs" Inherits="demo.UserControl.Sensor5_Chart" %>
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
    ...
    <SelectParameters>
        <asp:Parameter DefaultValue="5" Name="传感器编号" Type="Int32" />
    </SelectParameters>
</asp:SqlDataSource>
